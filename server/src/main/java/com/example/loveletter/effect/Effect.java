...
/**
 * Each card's special power is implemented by a class that implements this interface.
 * The effect is applied when the card is discarded (unless otherwise noted by special rules).
 */
