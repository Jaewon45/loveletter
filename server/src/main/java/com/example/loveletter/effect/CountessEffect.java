 ...
 * 
 * The real rule: if you ever hold the Countess + (King or Prince),
 * you must discard the Countess. That logic is typically enforced 
 * outside the 'apply' method (e.g., in Game or the player's draw logic).
 */
